...
all_results = gillespy_times.append(biosimulator_times).append(stochkit_times)
print(all_results)

from matplotlib import pyplot as plt
df = all_results
order = int(len(df['VilarOscillator'].index) / 3)
...
plt.legend([l1, l2, l3], ['GillesPy2', 'BioSimulator.jl', 'StochKit'])
plt.show()
